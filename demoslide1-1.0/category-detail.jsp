...
<c:choose><c:when test="${not empty sessionScope.account}"><a href="profile.jsp" class="ic-btn account-active" title="Tài khoản: ${sessionScope.account.fullName}">
          ...
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1.5"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 4 7 8 7"/></svg>
            ...
            <div class="product-detail-card">
              ...
              <div class="p-info-box">
                ...
                <div class="btn-actions">
                  ...
                  <button type="button" class="btn-action-main btn-ajax-cart" data-id="${p.id != 0 ? p.id : p.productId}">THÊM VÀO GIỎ HÀNG</button>
                </div>
              </div>
