...
public class UserDAO {
        ...
        try {
            ...
            if (rs.next()) {
                if (!"Active".equalsIgnoreCase(rs.getString("status"))
                        || !PasswordUtil.matches(password, rs.getString("password"))) {
                    return null;
                }
                return new User(
                        rs.getInt("user_id"),
    ...
    public boolean updateProfile(User user) {
        String sql = "UPDATE [User] SET full_name = ?, phone_number = ?, address = ? WHERE user_id = ?";
    ...
    String sql = "UPDATE Users SET fullName = ?, phoneNumber = ?, address = ?, avatar = ? WHERE id = ?";
