          ...
          <div class="form-box">
            ...
            <div style="display:flex;flex-direction:column;gap:12px;">
              <label class="payment-option">
                <input type="radio" name="paymentMethod" value="cod" checked style="accent-color:var(--pink-primary);width:18px;height:18px;cursor:pointer;">
              ...
              <label class="payment-option">
                <input type="radio" name="paymentMethod" value="card" style="accent-color:var(--pink-primary);width:18px;height:18px;cursor:pointer;">
                ...
                <span style="font-size:13px;font-weight:700;color:var(--text-chocolate);">Thẻ ngân hàng / Chuyển khoản QR</span>
              </label>
            </div>

            <div id="card-fields-box" style="display:none;background:var(--pink-subtle);padding:16px;border:1.5px solid var(--border-soft);border-radius:var(--radius-sm);margin-top:16px;">
              <div class="form-row">
                <div class="form-group">
