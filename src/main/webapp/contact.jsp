...
<div class="wire-page">
  ...
  <main class="main-content">
    ...
    <div style="text-align:center; margin-bottom:36px;">
      <h1 style="font-size:24px; font-weight:bold; text-transform:uppercase; letter-spacing:1px; margin:0 0 8px 0;">Hỗ Trợ &amp; Dịch Vụ Khách Hàng</h1>
    ...
    <div class="contact-form-layout">
      ...
      <div class="form-box">
        <h2 style="border-bottom:2px solid #000; padding-bottom:12px; margin:0 0 20px 0; font-size:15px; font-weight:bold; text-transform:uppercase;">GỬI TIN NHẮN TƯ VẤN</h2>
