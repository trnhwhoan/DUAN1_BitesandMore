...
<head>
  ...
  <title>Bites & More — Contact Us</title>
...
<div class="wire-page">
  ...
  <div class="wf-header">
    ...
    <nav class="wf-nav">
      ...
      <a href="contact.jsp" style="text-decoration:underline;">Contact</a>
    </nav>
  ...
  <div class="section" style="padding:0;">
    <div class="img-ph" style="height:220px;">Image (Map)</div>
  </div>
  ...
  <div class="section" style="padding:40px;">
    ...
    <div class="row" style="margin-bottom:40px;">
      ...
      <div class="col-4" style="text-align:center;">
        <div class="img-ph" style="height:64px;width:64px;border-radius:50%;margin:0 auto 14px;">
        ...
        <div style="font-weight:bold;margin-bottom:6px;">Our Location</div>
        <div style="font-size:13px;color:#444;">123 Bakery Street, Da Nang City</div>
      </div>
      ...
      <div class="col-4" style="text-align:center;">
        ...
        <div style="font-weight:bold;margin-bottom:6px;">Call Us</div>
        <div style="font-size:13px;color:#444;">(000) 123-4567</div>
      </div>
      ...
      <div class="col-4" style="text-align:center;">
        ...
        <div style="font-weight:bold;margin-bottom:6px;">Email Us</div>
    ...
    <div class="row">
      <div class="col-6">
        <div class="img-ph" style="height:420px;">Image</div>
      </div>
      <div class="col-6">
        <div class="filter-block">
          <h5 style="border-bottom:1px solid #000;padding-bottom:10px;margin-bottom:20px;">Send Us a Message</h5>
          <form action="contact" method="POST">
            <div class="row">
              <div class="col-6 field">
                <label style="display:block;margin-bottom:6px;font-size:13px;font-weight:bold;">Name</label>
            ...
            <div class="field" style="margin-top:16px;">
              <label style="display:block;margin-bottom:6px;font-size:13px;font-weight:bold;">Subject</label>
              <input type="text" name="subject" class="input" placeholder="Subject" required>
            </div>

            <div class="field" style="margin-top:16px;">
              <label style="display:block;margin-bottom:6px;font-size:13px;font-weight:bold;">Message</label>
              <textarea name="message" class="input" rows="5" placeholder="Write your message..." required style="resize:vertical;"></textarea>
            </div>

            <button type="submit" class="btn btn-dark" style="margin-top:20px;display:inline-flex;align-items:center;gap:8px;">
              Send Message
