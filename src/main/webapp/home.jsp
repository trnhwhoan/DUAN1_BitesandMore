...
<head>
  ...
  <title>Bites & More — Home Page</title>
...
<div class="wire-page">
  ...
  <div class="wf-header">
    ...
    <nav class="wf-nav">
      <a href="home.jsp" style="text-decoration:underline;">Home</a>
      <a href="shop.jsp">Shop</a>
      <a href="categories.jsp">Categories <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6,9 12,15 18,9"/></svg></a>
  ...
  <div class="section">
    ...
    <div class="row">
      <div class="col-2" style="text-align:center;margin-bottom:20px;"><div class="img-ph" style="height:140px;"><img src="images/bread.jpg" alt="Bread" style="width:100%; height:100%; object-fit:cover;"></div><div style="margin-top:12px;font-size:14px;font-weight:bold;">Breads</div></div>
      <div class="col-2" style="text-align:center;margin-bottom:20px;"><div class="img-ph" style="height:140px;"><img src="images/cakes.jpg" alt="Cake" style="width:100%; height:100%; object-fit:cover;"></div><div style="margin-top:12px;font-size:14px;font-weight:bold;">Cakes</div></div>
      <div class="col-2" style="text-align:center;margin-bottom:20px;"><div class="img-ph" style="height:140px;"><img src="images/pastries.jpg" alt="Pastry" style="width:100%; height:100%; object-fit:cover;"></div><div style="margin-top:12px;font-size:14px;font-weight:bold;">Pastries</div></div>
      <div class="col-2" style="text-align:center;margin-bottom:20px;"><div class="img-ph" style="height:140px;"><img src="images/cookies.jpg" alt="Cookie" style="width:100%; height:100%; object-fit:cover;"></div><div style="margin-top:12px;font-size:14px;font-weight:bold;">Cookies</div></div>
      <div class="col-2" style="text-align:center;margin-bottom:20px;"><div class="img-ph" style="height:140px;"><img src="images/donuts.jpg" alt="Donut" style="width:100%; height:100%; object-fit:cover;"></div><div style="margin-top:12px;font-size:14px;font-weight:bold;">Donuts</div></div>
      <div class="col-2" style="text-align:center;margin-bottom:20px;"><div class="img-ph" style="height:140px;"><img src="images/cupcakes.jpg" alt="Cupcake" style="width:100%; height:100%; object-fit:cover;"></div><div style="margin-top:12px;font-size:14px;font-weight:bold;">Cupcakes</div></div>
    </div>
  </div>
  ...
  <div class="section">
    ...
    <div class="section-subtitle">Hand-picked favorites from our bakery</div>
      ...
      <div class="col-3" style="margin-bottom:24px;">
        <div class="product-card">
          ...
          <div class="pc-body">
            ...
            <div class="pc-cart-btn"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1.5"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg> Add to Cart</div>
          </div>
        </div>
      </div>
  ...
  <!-- PROMOTIONAL BANNER -->
  <div class="section" style="padding:0;">
    <div class="img-ph" style="height:240px;">Image (Promotional Banner)</div>
  </div>
