...
<head>
  ...
  <title>Bites & More — Login</title>
  <!-- Nhúng đúng đường dẫn CSS -->
...
<div class="wire-page">
  ...
  <div class="section" style="display:flex;justify-content:center;padding:60px 40px;">
    <div style="width:100%;max-width:480px;">
      ...
      <div style="font-size:26px;font-weight:bold;text-align:center;margin-bottom:8px;">Welcome Back</div>
      <div style="font-size:14px;color:#444;text-align:center;margin-bottom:32px;">Log in to your Bites &amp; More account</div>
      ...
      <div class="filter-block">
        ...
        <form action="login" method="POST">
          ...
          <div class="field" style="margin-top:16px;">
            <label style="display:block;margin-bottom:6px;font-size:13px;font-weight:bold;">Password</label>
          ...
          <div style="display:flex;justify-content:space-between;align-items:center;margin:20px 0;font-size:13px;">
            ...
            <a href="forgot-password.jsp" style="text-decoration:underline;color:#000;">Forgot Password?</a>
          </div>
        ...
        <div style="text-align:center;margin:20px 0;font-size:12px;color:#777;">— OR —</div>

        <!-- Button Google kèm Icon Mail SVG -->
        <button type="button" class="btn btn-block" style="display:flex;align-items:center;justify-content:center;gap:10px;">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div style="text-align:center;margin-top:24px;font-size:13px;">
          Don't have an account? <a href="register.jsp" style="text-decoration:underline;font-weight:bold;color:#000;">Sign Up</a>
        </div>
      </div>
