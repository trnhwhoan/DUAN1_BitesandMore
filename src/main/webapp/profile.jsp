        ...
        <aside class="user-sidebar">
          ...
          <div class="side-nav">
            ...
            <a href="contact.jsp?feedback=true" class="side-link">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 21s-7-4.35-9.5-8.5C1 9 2.5 5.5 6 5c2-.3 3.5.8 6 3.3C14.5 5.8 16 4.7 18 5c3.5.5 5 4 3.5 7.5C19 16.65 12 21 12 21z"/></svg>
              Góp ý / Phản hồi
            </a>
    ...
    axios.get('https://esgoo.net/api-tinhthanh/1/0.htm')
      .then(function (response) {
        if (response.data.error === 0) {
          var dataTinh = response.data.data;
          dataTinh.forEach(function (tinh) {
