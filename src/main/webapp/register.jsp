...
<head>
  ...
  <title>Bites & More — Register</title>
...
<div class="wire-page">
  ...
  <div class="section" style="display:flex;justify-content:center;padding:60px 40px;">
    <div style="width:100%;max-width:560px;">
      ...
      <div style="font-size:26px;font-weight:bold;text-align:center;margin-bottom:8px;">Create an Account</div>
      <div style="font-size:14px;color:#444;text-align:center;margin-bottom:32px;">Join Bites &amp; More for exclusive offers</div>

      <div class="filter-block">
        <!-- Form gửi dữ liệu đăng ký sang RegisterServlet bằng POST -->
        ...
        <div style="text-align:center;margin-top:24px;font-size:13px;">
          Already have an account? <a href="login.jsp" style="text-decoration:underline;font-weight:bold;color:#000;">Log In</a>
        </div>
      </div>
